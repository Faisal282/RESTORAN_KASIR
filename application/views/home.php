...
<body>
	<div class="author-quote-wrap">
		...
		<div class="author-quote">
			...
			<div class="pull-right quote-content">
				<div class="clearfix animated zoomIn">
					<div class="quote-like pull-right"><span class="love"></span> 423</div>
				</div>
				<div class="quote-text animated rotateInDownRight">
                Percayalah bahwa<br>Kamu lebih kuat<br>Dari yang telah kamu <br>pikirkan, Maka<br> janganlah bergantung pada orang lain
                </div>
		...
		<div class="author-quote">
			...
			<div class="pull-right quote-content">
				<div class="clearfix animated zoomIn">
					<div class="quote-like pull-right"><span class="love"></span> 512</div>
				</div>
				<div class="quote-text animated zoomInDown">Hidup yang berkualitas adalah belajar untuk mandiri tanpa mengeluh atas apa yang diberikan
				</div>
